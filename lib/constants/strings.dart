...
class Strings {
  ...
  static const String firebaseErrorUserDisabled = 'user-disabled';
  static const String firebaseErrorUserNotFound = 'user-not-found';
  static const String firebaseErrorWrongPassword = 'wrong-password';

  // Firebase error codes for createUserWithEmailAndPassword
  static const String firebaseErrorEmailAlreadyInUse = 'email-already-in-use';
  //static const String firebaseErrorInvalidEmail = 'invalid-email';
  static const String firebaseErrorOperationNotAllowed = 'operation-not-allowed';
  static const String firebaseErrorWeakPassword = 'weak-password';

  // Firebase error codes
  static const String firebaseErrorNetworkRequestFailed = 'network-request-failed';
